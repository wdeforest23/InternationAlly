...
# Build Docker image
docker image build -t us-docker.pkg.dev/adsp-capstone-property-pilot/property-pilot-app-demo/cloud-app:latest .


# Push Docker image into artifact registry
docker push us-docker.pkg.dev/adsp-capstone-property-pilot/property-pilot-app-demo/cloud-app:latest
